    ...
    return(
      ...
      <header class='w-full max-h-28 px-10 pb-8 mx-auto rounded-b-lg bg-white shadow-xl'>
          <div class='text-base pt-4 leading-3 background bg-white mx-auto space-y-6'>
            <button onClick={() => window.location.href="../../.."} class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
            Go Home
            </button>
